    ...
    <div id="container">
      ...
      <div class="main">
        <div class="left">
          ...
          <p>
            <ul>
              ...
              <li><a href="#">Home</a></li>
              <li><a href="daftar_buku.php">Buku Online</a></li>
        ...
        <div class="middle">
          ...
          <div align="center">
            <img src="images/TGD.jpg" width="240" >
          </div>
          <p><a href="https://id.wikipedia.org/wiki/The_God_Delusion" target="_blank">Baca Wikipedia >>></a></p>
        </div>
        <div class="right">
